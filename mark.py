    ...
    while True:
        try:
            while mark_from_user != -1:
                ...
                # if the user enters a negative input then ask to input a positive number
            ...
            print("\n", end="")
# displays user's input and shows the average of the numbers.
